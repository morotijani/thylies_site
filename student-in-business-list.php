            ...
            <div class="container">
                <div class="card rounded-3 mb-4 ">
                    <div class="card-header bg-white p-4 border-bottom-0">
                        ...
                        <?php else: ?>
                       <h3 class="mb-0 h4">Student in Business List <?= date('Y'); ?></h3>
                       <br>
                       <div class="d-inline">
                                ...
                                <tbody>
                                    <?php if (isset($_GET['q'])): ?>
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <p class="px-3 text-muted small"><a href="<?= PROOT; ?>student-in-business-list"><< go back</a></p>
                                    ...
                                    <?php $i = 1; foreach ($rows as $row): ?>
                                        <tr>
                                           ...
                                           <td class="align-middle"><a href="<?= PROOT; ?>auth/auth-student-in-business-status/<?= $row['sib_id']; ?>">view status</a></td>
                                        </tr>
                                    <?php $i++; endforeach; ?>
                                    <?php else: ?>
                                        <tr>
