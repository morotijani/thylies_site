				...
				<div class="row align-items-center">
					...
					<div class="col-sm-auto col-12 mt-4 mt-sm-0">
						<div class="hstack gap-2 justify-content-sm-end">
							<a href="<?= PROOT; ?>admin/SIB/trash" class="btn btn-sm btn-neutral border-base">
        ...
        <div class="container-fluid">
            ...
            <div class="vstack gap-4">
                <div class="d-flex flex-column flex-md-row gap-3 justify-content-between">
                    ...
                    <div class="btn-group">
                        <a href="<?= PROOT; ?>admin/SIB" class="btn btn-sm btn-neutral">View all</a> 
                        <a href="<?= PROOT; ?>admin/SIB/trash" class="btn btn-sm btn-neutral text-primary" aria-current="page">Trash</a> 
...
<script>
    ...
    function load_data(page, query = '') {
        $.ajax({
            url : "<?= PROOT; ?>parsers/sib.trashed.list.php",
            method : "POST",
            data : {
                page : page, 
                query : query
