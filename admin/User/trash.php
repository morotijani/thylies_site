		...
		<div class="container-fluid">
			<div class="border-bottom pt-6">
				<div class="row align-items-center">
					<div class="col-sm col-12">
						<h1 class="h2 ls-tight">
							<span class="d-inline-block me-3">🤧</span>Trashed, Users list
						</h1>
					</div>
					<div class="col-sm-auto col-12 mt-4 mt-sm-0">
						<div class="hstack gap-2 justify-content-sm-end">
							<a href="<?= PROOT; ?>admin/users" class="btn btn-sm btn-neutral border-base">
				...
				<ul class="nav nav-tabs overflow-x border-0">
					<li class="nav-item"><a href="<?= PROOT; ?>admin/User/" class="nav-link">View all</a></li>
					<li class="nav-item"><a href="<?= PROOT; ?>admin/User/trash" class="nav-link active">Trash</a></li>
				</ul>
			</div>
		</div>
	</header>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="<?= PROOT; ?>admin/User/export/trash/xlsx" class="dropdown-item">XLSX</a>
                                <a href="<?= PROOT; ?>admin/User/export/trash/xls" class="dropdown-item">XLS</a>
                                <a href="<?= PROOT; ?>admin/User/export/trash/csv" class="dropdown-item">CSV</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function load_data(page, query = '') {
        $.ajax({
            url : "<?= PROOT; ?>/parsers/users.trashed.list.php",
            method : "POST",
            data : {
                page : page, 
                query : query
